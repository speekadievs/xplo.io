...
var MineObject = __webpack_require__(129);
var GrenadeObject = __webpack_require__(130);
        ...
        value: function onKilled(data) {
            ...
            if (player) {
                ...
                setTimeout(function () {
                    ...
                    _this7.engine.state.start('BlankStage', true);
