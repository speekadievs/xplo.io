...
var PositionService = __webpack_require__(126);
var RemotePlayer = __webpack_require__(127);
var FoodObject = __webpack_require__(128);
var BuffObject = __webpack_require__(129);
var MineObject = __webpack_require__(130);
var GrenadeObject = __webpack_require__(131);
...
var GameService = function () {
    ...
    _createClass(GameService, [{
        ...
        value: function newEnemy(data) {
            var newEnemy = new RemotePlayer(data.id, data.username, data.x, data.y, data.size, data.angle, data.color, data.shield, this, this.socket);
        ...
        value: function onKilled(data) {
            ...
            if (player) {
                ...
                setTimeout(function () {
                    ...
                    _this8.engine.state.start('BlankStage', true);
...
var RemotePlayer = function () {
    function RemotePlayer(id, username, startx, starty, startSize, start_angle, color, shield, game, socket) {
