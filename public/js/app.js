...
window.chooseRegion = function (region) {
    ...
    socket.on("connected", function () {
        ...
        var engine = new Phaser.Game(window.innerWidth, window.innerHeight, Phaser.CANVAS, 'game');
        var game = new GameService(engine, socket);

        var BlankStage = function BlankStage(game) {
        ...
        window.startGame = function () {
            ...
            gameElement.find('canvas').attr('width', window.innerWidth).attr('height', window.innerHeight);
        };
...
var BuffObject = __webpack_require__(136);
var MineObject = __webpack_require__(137);
var GrenadeObject = __webpack_require__(138);
var FlagObject = __webpack_require__(139);
    ...
    _createClass(GameService, [{
        ...
        value: function createMiniMap() {
            ...
            if (window.gameMode === 'ctf') {
                var widthPercent = this.properties.base_width / this.properties.server_width * 100;
                var heightPercent = this.properties.base_height / this.properties.server_height * 100;

                var width = 200 * (widthPercent / 100);
                var height = 200 * (heightPercent / 100);

                var redBase = this.engine.add.graphics(0, 0, this.map_group);
                redBase.beginFill(0xbe0000);
                redBase.drawRoundedRect(0, 0, width, height, 5);
                redBase.alpha = 0.5;

                var blueBase = this.engine.add.graphics(0, 0, this.map_group);
        ...
        key: 'launchExplosion',
        value: function launchExplosion(x, y) {
            // Get the first dead explosion from the explosionGroup
            var explosion = this.explision_group.getFirstDead();
        ...
        value: function createPlayer(data) {
            ...
            try {
                ...
                var shieldIncrease = this.engine.add.graphics(0, 0, this.buffs.shield_increase);
                shieldIncrease.beginFill(0x09be00);
                shieldIncrease.drawRoundedRect(0, 0, 40, 40, 5);
                shieldIncrease.alpha = 0.5;

                var shieldIncreaseIcon = this.engine.add.sprite(20, 20, 'shield_increase', this.buffs.shield_increase);
                ...
                var shieldDecrease = this.engine.add.graphics(0, 0, this.buffs.shield_decrease);
                shieldDecrease.beginFill(0xbe0000);
                shieldDecrease.drawRoundedRect(0, 0, 40, 40, 5);
                shieldDecrease.alpha = 0.5;

                var shieldDecreaseIcon = this.engine.add.sprite(20, 20, 'shield_decrease', this.buffs.shield_decrease);
                ...
                var speedIncrease = this.engine.add.graphics(0, 0, this.buffs.speed_increase);
                speedIncrease.beginFill(0x09be00);
                speedIncrease.drawRoundedRect(0, 0, 40, 40, 5);
                speedIncrease.alpha = 0.5;

                var speedIncreaseIcon = this.engine.add.sprite(20, 20, 'speed_increase', this.buffs.speed_increase);
                ...
                var speedDecrease = this.engine.add.graphics(0, 0, this.buffs.speed_decrease);
                speedDecrease.beginFill(0xbe0000);
                speedDecrease.drawRoundedRect(0, 0, 40, 40, 5);
                speedDecrease.alpha = 0.5;

                var speedDecreaseIcon = this.engine.add.sprite(20, 20, 'speed_decrease', this.buffs.speed_decrease);
                ...
                var leaderBoard = this.engine.add.graphics(0, 0, this.leaderboard);
                ...
                var shieldBox = this.engine.add.graphics(0, 0, this.shield_box);
                ...
                var mineBox = this.engine.add.graphics(0, 0, this.mine_box);
                ...
                var grenadeBox = this.engine.add.graphics(0, 0, this.grenade_box);
                ...
                if (window.gameMode !== 'classic') {
                    ...
                    var seconds = data.match.total_time - (currentTime - data.match.start_time) / 1000;

                    // Create a custom timer
                    this.match.timer = this.engine.time.create();

                    // Create a delayed event 1m and 30s from now
                    this.match.timer_event = this.match.timer.add(Phaser.Timer.SECOND * seconds, function () {
                        _this.match.timer.stop();
                    }, this.engine);
                ...
                this.ping_interval = setInterval(function () {
                    _this.socket.emit('last-move');
                }, 10000);

                if (window.gameMode !== 'classic') {
                    this.score_interval = setInterval(function () {
                        _this.socket.emit('get-score');
                    }, 5000);
                }
            } catch (e) {
                console.error(e);
        ...
        key: 'newEnemy',
        value: function newEnemy(data) {
            try {
                var newEnemy = new RemotePlayer(data.id, data.username, data.skin, data.team, data.x, data.y, data.size, data.angle, data.color, data.shield, data.is_god, this, this.socket);
        ...
        key: 'findPlayer',
        value: function findPlayer(id, returnKey) {
        ...
        key: 'findItem',
        value: function findItem(id, returnKey) {
            if (typeof returnKey === 'undefined') returnKey = false;
        ...
        key: 'findBuff',
        value: function findBuff(id, returnKey) {
            if (typeof returnKey === 'undefined') returnKey = false;

            for (var i = 0; i < this.buff_list.length; i++) {
        ...
        key: 'findMine',
        value: function findMine(id, returnKey) {
            if (typeof returnKey === 'undefined') returnKey = false;

            for (var i = 0; i < this.mine_list.length; i++) {
        ...
        key: 'findGrenade',
        value: function findGrenade(id, returnKey) {
            if (typeof returnKey === 'undefined') returnKey = false;
        ...
        value: function onInputReceived(data) {
            ...
            // telemetry
            this.last_moves = this.last_moves.filter(function (savedMove) {
            ...
            this.last_moves.forEach(function (savedMove) {
        ...
        key: 'onMinePickedUp',
        value: function onMinePickedUp(data) {
            player.mines.push(data.object);

            this.mine_box.text.setText(player.mines.length);
        }
    }, {
        key: 'onGrenadePickedUp',
        value: function onGrenadePickedUp(data) {
        ...
        key: 'onBuffRemove',
        value: function onBuffRemove(data) {
            if (!this.properties.in_game) {
                return false;
            }

            var removeItem = this.findBuff(data.id);
            var removeItemKey = this.findBuff(data.id, true);
        ...
        value: function onItemRemove(data) {
            ...
            var removeItem = this.findItem(data.id);
        ...
        value: function onRemovePlayer(data) {
            ...
            var removePlayer = this.findPlayer(data.id);
            // Player not found
            if (!removePlayer) {
        ...
        key: 'onGetScore',
        value: function onGetScore(data) {
            if (window.gameMode !== 'classic') {
        ...
        key: 'onStopGodMode',
        value: function onStopGodMode(data) {
            if (data.id === player.id) {
        ...
        key: 'onShowBuff',
        value: function onShowBuff(data) {
            this.buffs[data.type].visible = true;
        }
    }, {
        key: 'onHideBuff',
        value: function onHideBuff(data) {
        ...
        key: 'onDropFlag',
        value: function onDropFlag(data) {
            this[data.team + '_flag'].x = data.x;
            this[data.team + '_flag'].x = data.x;
            this[data.team + '_flag'].item.x = data.x;
            this[data.team + '_flag'].item.y = data.y;
        ...
        value: function onKilled(data) {
            ...
            if (player) {
                ...
                var deadBlock = jQuery('#dead');
                deadBlock.find('.score').text(data.score);

                var aliveTime = new Date().getTime() - data.start_time;
                var formatted = moment.utc(aliveTime).format('HH:mm:ss');
        ...
        key: 'onMatchEnded',
        value: function onMatchEnded(data) {
        ...
        value: function restart() {
            ...
            this.buff_list.forEach(function (item) {
                item.item.destroy();
                if (item.buffIcon) {
...
var Player = function () {
            ...
            if (window.skin) {
                if (window.skins.indexOf(window.skin) !== -1) {
                    if (game.engine.cache.checkImageKey('skins')) {
                        var skin = game.engine.add.sprite(0, 0, 'skins', this.player);
    ...
    _createClass(Player, [{
        ...
        key: 'flagPickedUp',
        value: function flagPickedUp(game) {
            if (this.map) {
                this.map.destroy();
            }
        ...
        key: 'createLeader',
        value: function createLeader(game) {
            if (this.map) {
                this.map.destroy();
            }
        ...
        key: 'removeFlag',
        value: function removeFlag(game) {
            if (this.flag) {
                this.flag.destroy();
                this.flag = null;
...
var RemotePlayer = function () {
    function RemotePlayer(id, username, skin, team, startx, starty, startSize, start_angle, color, shield, is_god, game, socket) {
        _classCallCheck(this, RemotePlayer);
        ...
        if (window.gameMode === 'classic') {
            if (skin) {
                if (game.engine.cache.checkImageKey(skin)) {
                    var _skin = game.engine.add.sprite(0, 0, _skin, this.player);
                    _skin.anchor.setTo(0.5, 0.5);

                    this.player.addChild(_skin);
                }
            }
        }
...
var FoodObject = function FoodObject(id, type, startx, starty, color, size, line_size, game) {
    _classCallCheck(this, FoodObject);
    ...
    var graphics = game.engine.add.graphics(startx, starty, game.item_group);
...
var BuffObject = function BuffObject(id, type, startx, starty, color, size, line_size, game) {
    _classCallCheck(this, BuffObject);
    ...
    this.item.addChild(this.buffIcon);
...
var MineObject = function MineObject(id, startx, starty, color, size, line_size, user_id, engine) {
    _classCallCheck(this, MineObject);
...
var FlagObject = function () {
    function FlagObject(data, game) {
        ...
        var graphics = game.engine.add.graphics(data.x, data.y, game.item_group);
    ...
    _createClass(FlagObject, [{
        key: 'repositionMap',
        value: function repositionMap(game) {
            if (this.map) {
