...
var GameService = __webpack_require__(3);
...
var PositionService = __webpack_require__(4);
...
var GameService = function () {
    ...
    _createClass(GameService, [{
        ...
        value: function newEnemy(data) {
            var newEnemy = new RemotePlayer(data.id, data.x, data.y, data.size, data.angle, data.color, data.shield, this.engine, this.socket);
...
var RemotePlayer = function RemotePlayer(id, startx, starty, startSize, start_angle, color, shield, engine, socket) {
