    ...
    MainStage.prototype = {
        ...
        update: function update() {
            ...
            if (game.properties.in_game) {
                ...
                //the server.
                var pointer = engine.input.mousePointer;
...
var GameService = function () {
    ...
    _createClass(GameService, [{
        ...
        value: function newEnemy(data) {
            var newEnemy = new RemotePlayer(data.id, data.username, data.x, data.y, data.size, data.angle, data.color, data.shield, this.engine, this.socket);
...
var RemotePlayer = function () {
    function RemotePlayer(id, username, startx, starty, startSize, start_angle, color, shield, engine, socket) {
